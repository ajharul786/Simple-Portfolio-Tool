...
<?php
	if(isset($_GET['id'])){
		...
		$id=$_GET['id'];
		$qury1="delete from social_media where user_id='$id'";
		$update1=mysqli_query($connection, $qury1);
				$qury="delete from experience where user_id='$id'";
...
?>
    ...
    <br>
	<div class="container" style="border:2px solid #007EC2;">
	<div class="row">
	<div class="col-sm-3">
...
<?php } ?>	
	...
	<div class="col-sm-1">
	<br><br>
	<a href="admin.php?id=<?php echo $user_id; ?>" class="btn btn-danger"> Delete </a>
	</div>
